...
function Login({ onLogin }) {
  ...
  const handleLogin = async () => {
    ...
    try {
      ...
      if (!privateKeyHex) {
        setError(
          "No private key found for this user. Contact your system administrator."
        );
        setIsLoading(false);
        return;
      }
      ...
      if (verifyData.status === "Login successful") {
        setError("");
        onLogin(username);
      } else {
    ...
    <div className="login-bg">
      <div className="login-card">
        ...
        <div
          ...
          style={{ visibility: error ? "visible" : "hidden", minHeight: "1.5em" }}
        >
          {error || "\u00A0"}
        </div>
